...
<body class="dashboard-body">
  ...
  <aside class="sidebar">
    <div class="sidebar-top">
      ...
      <nav class="sidebar-nav">
        ...
        <a href="{{ route('riwayat') }}" class="sidebar-link active">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
  ...
  <div class="dash-right">
    ...
    <main class="dash-scroll">
      ...
      <div class="dash-main-card">
        ...
        <!-- Header Control Panel ala FDM versi KindlyJAR -->
        <div class="dm-control-bar">
            ...
            <span class="dm-total-info">Total: 5 Aset Unduhan</span>
            </div>
        </div>

        <!-- Table List Download ala FDM -->
  ...
  <nav class="dash-bottom-nav" aria-label="Navigasi mobile">
    ...
    <a href="{{ route('riwayat') }}" class="dash-bnav-item active" aria-label="Riwayat">
      <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
        <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/>
        <polyline points="7 10 12 15 17 10"/>
        <line x1="12" y1="15" x2="12" y2="3"/>
